...
fd = FaceDetector(r'C:\College learnings\Development\Digilocker_project\Backend\PROJECT_VOTING_SYSTEM\Required Models (2_7)\haarcascade_frontalface_default.xml')
